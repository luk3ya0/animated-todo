...
*** DONE {{youtube-timestamp 5502}} Animate background color
*** DONE {{youtube-timestamp 5780}} Add masthead
*** DONE {{youtube-timestamp 6186}} Fix scrollview
*** DONE {{youtube-timestamp 6329}} Implement sidebar content
*** TODO {{youtube-timestamp 6976}} Add about screen
*** DONE {{youtube-timestamp 7520}} Testing on Android